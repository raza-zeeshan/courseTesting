...
public class ExcelUtils 
{
	...
	public static void write(String sheetName, int rownum, int colnum, String data)throws IOException {
		...
		FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\testdata\\coursess.xlsx");
		...
		FileOutputStream fo=new FileOutputStream(System.getProperty("user.dir")+"\\testdata\\coursess.xlsx");
